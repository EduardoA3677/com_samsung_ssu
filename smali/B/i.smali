...
# direct methods
.method public static i0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    .locals 5
    ...
    invoke-static {v0, v1}, LB/i;->k0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, LB/i;->k0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static j0([LF/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    iget-object v5, v4, LF/i;->a:Landroid/net/Uri;
...
.method public static k0(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    .locals 2
...
.method public final h(Landroid/content/Context;LA/e;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    iget-object v3, v3, LA/f;->d:Ljava/lang/String;
    ...
    invoke-static {p2, p4}, LB/i;->i0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final i(Landroid/content/Context;[LF/i;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p1}, LB/i;->j0([LF/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p1, p3}, LB/i;->i0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final j(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p1}, LB/i;->j0([LF/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {v4, p1}, LB/i;->j0([LF/i;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, LB/i;->i0(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final m([LF/i;I)LF/i;
    .locals 0
