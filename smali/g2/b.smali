...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lg2/b;->r:Ljava/lang/Object;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lg2/b;->i:Ljava/util/concurrent/atomic/AtomicLong;

    new-instance v1, Ljava/util/concurrent/atomic/AtomicLong;

    invoke-direct {v1}, Ljava/util/concurrent/atomic/AtomicLong;-><init>()V

    iput-object v1, p0, Lg2/b;->p:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iput-object v2, p0, Lg2/b;->m:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iput v1, p0, Lg2/b;->l:I
    ...
    iput v3, p0, Lg2/b;->j:I

    iput-object v2, p0, Lg2/b;->o:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iput v1, p0, Lg2/b;->n:I

    add-int/lit8 p1, p1, -0x2

    int-to-long v1, p1

    iput-wide v1, p0, Lg2/b;->k:J
...
.method public final clear()V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lg2/b;->f()Ljava/lang/Object;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lg2/b;->isEmpty()Z
...
.method public final f()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lg2/b;->o:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Lg2/b;->p:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sget-object v7, Lg2/b;->r:Ljava/lang/Object;
    ...
    iput-object v6, p0, Lg2/b;->o:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
.method public final i(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lg2/b;->m:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    iget-object v1, p0, Lg2/b;->i:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget v5, p0, Lg2/b;->l:I

    and-int/2addr v4, v5

    iget-wide v6, p0, Lg2/b;->k:J
    ...
    iput-object v13, p0, Lg2/b;->m:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    add-long/2addr v2, v5

    sub-long/2addr v2, v7

    iput-wide v2, p0, Lg2/b;->k:J
    ...
    sget-object p1, Lg2/b;->r:Ljava/lang/Object;
...
.method public final isEmpty()Z
    ...
    iget-object v0, p0, Lg2/b;->i:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicLong;->get()J

    move-result-wide v0

    iget-object v2, p0, Lg2/b;->p:Ljava/util/concurrent/atomic/AtomicLong;
