...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, p0, Ll/C;->b:Landroid/graphics/Rect;

    sget-object v1, Lc/a;->s:[I

    invoke-static {p1, p2, v1, p3}, LA0/p;->m(Landroid/content/Context;Landroid/util/AttributeSet;[II)LA0/p;

    move-result-object p2

    iget-object p3, p2, LA0/p;->i:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, Ll/C;->a(I)Landroid/transition/Transition;
    ...
    invoke-virtual {p0, v3}, Ll/C;->a(I)Landroid/transition/Transition;
    ...
    :cond_2
    invoke-virtual {p2, v0}, LA0/p;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    invoke-virtual {p0, p3}, Ll/C;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    xor-int/lit8 p3, v5, 0x1

    iput-boolean p3, p0, Ll/C;->e:Z
    ...
    iget-object p1, p0, Ll/C;->a:Landroid/content/Context;
...
.method public final getMaxAvailableHeight(Landroid/view/View;IZ)I
    ...
    invoke-static {v2, v3, p3}, LM0/g;->m(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    invoke-static {p1, p3, v2}, LM0/g;->v(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    iget-boolean p3, p0, Ll/C;->c:Z

    if-eqz p3, :cond_2

    iget-object p3, p0, Ll/C;->a:Landroid/content/Context;
    ...
    :cond_3
    iget-object v3, p0, Ll/C;->a:Landroid/content/Context;
    ...
    :cond_7
    iget-object v5, p0, Ll/C;->a:Landroid/content/Context;
    ...
    iget-object p3, p0, Ll/C;->b:Landroid/graphics/Rect;
