...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    iget-object v1, v1, LE0/E;->a:Ljava/util/HashMap;
    ...
    iget-object v2, v2, LE0/E;->a:Ljava/util/HashMap;
    ...
    iget-object v0, v2, LE0/D;->n:Landroid/content/ComponentName;
    ...
    :cond_2
    :goto_0
    invoke-virtual {v2, v0}, LE0/D;->onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iget-object v4, v1, LE0/D;->i:Ljava/util/HashMap;
    ...
    iget-boolean v4, v1, LE0/D;->k:Z

    if-eqz v4, :cond_5

    iget-object v4, v1, LE0/D;->o:LE0/E;

    iget-object v4, v4, LE0/E;->c:LO0/e;

    iget-object v5, v1, LE0/D;->m:LE0/B;

    invoke-virtual {v4, v3, v5}, Landroid/os/Handler;->removeMessages(ILjava/lang/Object;)V

    iget-object v4, v1, LE0/D;->o:LE0/E;

    iget-object v5, v4, LE0/E;->d:LH0/b;

    iget-object v4, v4, LE0/E;->b:Landroid/content/Context;

    invoke-virtual {v5, v4, v1}, LH0/b;->c(Landroid/content/Context;Landroid/content/ServiceConnection;)V

    iput-boolean v2, v1, LE0/D;->k:Z

    const/4 v2, 0x2

    iput v2, v1, LE0/D;->j:I
    ...
    :try_start_2
    iget-object v2, v0, LA0/j;->m:Landroid/util/SparseArray;
    ...
    :cond_8
    iget-object v3, v0, LA0/j;->m:Landroid/util/SparseArray;

    invoke-virtual {v3, v1}, Landroid/util/SparseArray;->remove(I)V

    invoke-virtual {v0}, LA0/j;->c()V
    ...
    invoke-virtual {v2, p1}, LA0/k;->b(LA0/l;)V

    goto :goto_6

    :cond_9
    iget v0, v2, LA0/k;->e:I
    ...
    :cond_a
    invoke-virtual {v2, p1}, LA0/k;->c(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v2, v0}, LA0/k;->c(Landroid/os/Bundle;)V
