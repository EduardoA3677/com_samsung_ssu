...
.method public static a(Landroid/content/Context;Ljava/util/List;)LD0/x;
    .locals 5
    ...
    invoke-static {v3, v2, v4}, LF/c;->b(Landroid/content/pm/PackageManager;LF/d;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    invoke-static {p0, v2, v3}, LF/c;->c(Landroid/content/Context;LF/d;Ljava/lang/String;)[LF/i;
    ...
    invoke-direct {p0, v0}, LD0/x;-><init>(Ljava/util/ArrayList;)V
    :try_end_1
...
.method public static b(Landroid/content/pm/PackageManager;LF/d;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 9
    ...
    invoke-static {v2}, La1/b;->a(Ljava/lang/String;)V

    :try_start_0
    iget-object v2, p1, LF/d;->d:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v3, p1, LF/d;->a:Ljava/lang/String;

    iget-object p1, p1, LF/d;->b:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    invoke-static {p2, v4}, LA/b;->e(Landroid/content/res/Resources;I)Ljava/util/List;
    ...
    iput-object v3, p2, LF/b;->a:Ljava/lang/String;

    iput-object p1, p2, LF/b;->b:Ljava/lang/String;

    iput-object v2, p2, LF/b;->c:Ljava/util/List;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    sget-object v5, LF/c;->a:LZ/l0;

    :try_start_2
    invoke-virtual {v5, p2}, LZ/l0;->g(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {v5, p2, v6}, LZ/l0;->k(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_4
...
.method public static c(Landroid/content/Context;LF/d;Ljava/lang/String;)[LF/i;
    .locals 20
    ...
    iget-object v0, v0, LF/d;->c:Ljava/lang/String;
    ...
    invoke-direct/range {v14 .. v19}, LF/i;-><init>(Landroid/net/Uri;IIZI)V
