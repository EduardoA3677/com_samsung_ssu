...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Ll/q0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Ll/q0;->setBaselineAligned(Z)V
    ...
    iput v2, p0, Landroidx/appcompat/widget/ActionMenuView;->G:I
    ...
    :goto_0
    iput-boolean v1, p0, Landroidx/appcompat/widget/ActionMenuView;->Q:Z
    ...
    iput v5, p0, Landroidx/appcompat/widget/ActionMenuView;->J:I
    ...
    iput v6, p0, Landroidx/appcompat/widget/ActionMenuView;->K:I
    ...
    iput v2, p0, Landroidx/appcompat/widget/ActionMenuView;->L:I
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->P:Ljava/lang/String;
    ...
    iput p1, p0, Landroidx/appcompat/widget/ActionMenuView;->J:I
...
.method public static j(Landroid/view/ViewGroup$LayoutParams;)Ll/p;
    .locals 1
    ...
    iget-boolean p0, p0, Ll/p;->a:Z

    iput-boolean p0, v0, Ll/p;->a:Z
...
.method public final a(Lk/k;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->x:Lk/i;
    ...
    invoke-virtual {v0, p1, v2, v1}, Lk/i;->q(Landroid/view/MenuItem;Lk/t;I)Z
...
.method public final b(Lk/i;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->x:Lk/i;
...
.method public final bridge synthetic e()Ll/p0;
    .locals 1
...
.method public final f(Landroid/util/AttributeSet;)Ll/p0;
    .locals 2
...
.method public final bridge synthetic g(Landroid/view/ViewGroup$LayoutParams;)Ll/p0;
    .locals 0
...
.method public getMenu()Landroid/view/Menu;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->x:Lk/i;

    new-instance v2, Ll/D;

    invoke-direct {v2, p0}, Ll/D;-><init>(Ljava/lang/Object;)V

    iput-object v2, v1, Lk/i;->e:Lk/g;

    new-instance v1, Ll/n;

    invoke-direct {v1, v0}, Ll/n;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->B:Ll/n;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->C:LE0/G;
    ...
    invoke-direct {v0, v2}, Lo1/d;-><init>(I)V

    :goto_0
    iput-object v0, v1, Ll/n;->m:Lk/s;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->B:Ll/n;

    iput-object p0, v0, Ll/n;->p:Lk/v;

    iget-object v0, v0, Ll/n;->k:Lk/i;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->x:Lk/i;
...
.method public getOverflowBadgeText()Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->P:Ljava/lang/String;
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, v0, Ll/n;->q:Ll/l;

    if-eqz v1, :cond_1

    iget-object v0, v1, Ll/l;->k:Landroid/view/View;
    ...
    :cond_1
    iget-boolean v1, v0, Ll/n;->s:Z

    if-eqz v1, :cond_2

    iget-object v2, v0, Ll/n;->r:Landroid/graphics/drawable/Drawable;
...
.method public getSumOfDigitsInBadges()I
    ...
    :goto_0
    iget-object v2, p0, Landroidx/appcompat/widget/ActionMenuView;->x:Lk/i;

    iget-object v2, v2, Lk/i;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v0}, Lk/i;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    check-cast v2, Lk/k;

    invoke-virtual {v2}, Lk/k;->isVisible()Z
...
.method public final k(I)Z
    ...
    instance-of v3, v1, Ll/o;

    if-eqz v3, :cond_1

    check-cast v1, Ll/o;

    invoke-interface {v1}, Ll/o;->a()Z
    ...
    instance-of p1, v2, Ll/o;

    if-eqz p1, :cond_2

    check-cast v2, Ll/o;

    invoke-interface {v2}, Ll/o;->c()Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->B:Ll/n;
    ...
    iget-boolean p1, p0, Landroidx/appcompat/widget/ActionMenuView;->Q:Z
...
.method public final onLayout(ZIIII)V
    ...
    invoke-super/range {p0 .. p5}, Ll/q0;->onLayout(ZIIII)V
    ...
    invoke-virtual/range {p0 .. p0}, Ll/q0;->getDividerWidth()I
...
.method public final onMeasure(II)V
    ...
    :goto_0
    iput-boolean v3, v0, Landroidx/appcompat/widget/ActionMenuView;->E:Z
    ...
    iget-boolean v3, v0, Landroidx/appcompat/widget/ActionMenuView;->E:Z

    if-eqz v3, :cond_2

    iget-object v3, v0, Landroidx/appcompat/widget/ActionMenuView;->x:Lk/i;

    if-eqz v3, :cond_2

    iget v7, v0, Landroidx/appcompat/widget/ActionMenuView;->F:I

    if-eq v2, v7, :cond_2

    iput v2, v0, Landroidx/appcompat/widget/ActionMenuView;->F:I

    invoke-virtual {v3, v5}, Lk/i;->p(Z)V
    ...
    iget v9, v0, Landroidx/appcompat/widget/ActionMenuView;->G:I
    ...
    iput-boolean v5, v6, Ll/p;->f:Z

    iput v5, v6, Ll/p;->c:I

    iput v5, v6, Ll/p;->b:I

    iput-boolean v5, v6, Ll/p;->d:Z
    ...
    :goto_2
    iput-boolean v5, v6, Ll/p;->e:Z

    iget-boolean v5, v6, Ll/p;->a:Z
    ...
    :goto_7
    iput-boolean v4, v7, Ll/p;->d:Z

    iput v13, v7, Ll/p;->b:I
    ...
    :cond_1c
    :goto_10
    iget v3, v10, Ll/p;->b:I

    add-int/2addr v3, v2

    iput v3, v10, Ll/p;->b:I

    iput-boolean v2, v10, Ll/p;->f:Z
    ...
    iput-boolean v3, v4, Ll/p;->f:Z

    if-nez v2, :cond_25

    iget-boolean v3, v4, Ll/p;->e:Z
    ...
    :cond_30
    iget-boolean v6, v0, Landroidx/appcompat/widget/ActionMenuView;->Q:Z
    ...
    iget v3, v0, Landroidx/appcompat/widget/ActionMenuView;->J:I
    ...
    iget v3, v0, Landroidx/appcompat/widget/ActionMenuView;->L:I
    ...
    iget v3, v0, Landroidx/appcompat/widget/ActionMenuView;->O:I
    ...
    :cond_36
    invoke-super/range {p0 .. p2}, Ll/q0;->onMeasure(II)V
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    iput-boolean p1, v0, Ll/n;->y:Z

    return-void
.end method

.method public setOnMenuItemClickListener(Ll/q;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->I:Ll/q;
...
.method public setOverflowIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v1, v0, Ll/n;->s:Z

    iput-object p1, v0, Ll/n;->r:Landroid/graphics/drawable/Drawable;
...
.method public setPresenter(Ll/n;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->B:Ll/n;

    iput-object p0, p1, Ll/n;->p:Lk/v;

    iget-object p1, p1, Ll/n;->k:Lk/i;
