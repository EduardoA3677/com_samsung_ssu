...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v6, v7, v8, v9}, Landroid/widget/CompoundButton;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    const/4 v10, 0x0

    iput-object v10, v6, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/content/res/ColorStateList;

    iput-object v10, v6, Landroidx/appcompat/widget/SwitchCompat;->k:Landroid/graphics/PorterDuff$Mode;

    const/4 v11, 0x0

    iput-boolean v11, v6, Landroidx/appcompat/widget/SwitchCompat;->l:Z

    iput-boolean v11, v6, Landroidx/appcompat/widget/SwitchCompat;->m:Z

    iput-object v10, v6, Landroidx/appcompat/widget/SwitchCompat;->o:Landroid/content/res/ColorStateList;

    iput-object v10, v6, Landroidx/appcompat/widget/SwitchCompat;->p:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v11, v6, Landroidx/appcompat/widget/SwitchCompat;->q:Z

    iput-boolean v11, v6, Landroidx/appcompat/widget/SwitchCompat;->r:Z

    invoke-static {}, Landroid/view/VelocityTracker;->obtain()Landroid/view/VelocityTracker;

    move-result-object v0

    iput-object v0, v6, Landroidx/appcompat/widget/SwitchCompat;->F:Landroid/view/VelocityTracker;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v6, Landroidx/appcompat/widget/SwitchCompat;->W:Landroid/graphics/Rect;

    iput v11, v6, Landroidx/appcompat/widget/SwitchCompat;->f0:I

    invoke-virtual/range {p0 .. p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    invoke-static {v6, v0}, Ll/e1;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    iput-object v12, v6, Landroidx/appcompat/widget/SwitchCompat;->O:Landroid/text/TextPaint;
    ...
    invoke-virtual {v7, v8, v2, v5, v11}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v15

    invoke-direct {v14, v7, v15}, LA0/p;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    invoke-virtual {v14, v0}, LA0/p;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, v6, Landroidx/appcompat/widget/SwitchCompat;->i:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v14, v1}, LA0/p;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, v6, Landroidx/appcompat/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_3

    invoke-virtual {v1, v6}, Landroid/graphics/drawable/Drawable;->setCallback(Landroid/graphics/drawable/Drawable$Callback;)V

    iget-object v1, v6, Landroidx/appcompat/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v2, v6, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable$ConstantState;->newDrawable()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, v6, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, v6, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/graphics/drawable/Drawable;

    iput-object v1, v6, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/graphics/drawable/Drawable;

    :goto_1
    iget-object v1, v6, Landroidx/appcompat/widget/SwitchCompat;->a0:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v6, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v6, v1}, Landroidx/appcompat/widget/SwitchCompat;->setTextOnInternal(Ljava/lang/CharSequence;)V

    invoke-virtual {v15, v13}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-direct {v6, v1}, Landroidx/appcompat/widget/SwitchCompat;->setTextOffInternal(Ljava/lang/CharSequence;)V

    const/4 v1, 0x3

    invoke-virtual {v15, v1, v13}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, v6, Landroidx/appcompat/widget/SwitchCompat;->A:Z

    const/16 v2, 0x9

    invoke-virtual {v15, v2, v11}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, v6, Landroidx/appcompat/widget/SwitchCompat;->s:I
    ...
    iput v2, v6, Landroidx/appcompat/widget/SwitchCompat;->t:I
    ...
    iput v2, v6, Landroidx/appcompat/widget/SwitchCompat;->u:I
    ...
    iput-boolean v2, v6, Landroidx/appcompat/widget/SwitchCompat;->v:Z

    const/16 v2, 0xa

    invoke-virtual {v14, v2}, LA0/p;->e(I)Landroid/content/res/ColorStateList;

    move-result-object v2

    if-eqz v2, :cond_4

    iput-object v2, v6, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/content/res/ColorStateList;

    iput-boolean v13, v6, Landroidx/appcompat/widget/SwitchCompat;->l:Z
    ...
    invoke-static {v2, v10}, Ll/h0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v2

    iget-object v4, v6, Landroidx/appcompat/widget/SwitchCompat;->k:Landroid/graphics/PorterDuff$Mode;

    if-eq v4, v2, :cond_5

    iput-object v2, v6, Landroidx/appcompat/widget/SwitchCompat;->k:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v13, v6, Landroidx/appcompat/widget/SwitchCompat;->m:Z

    :cond_5
    iget-boolean v2, v6, Landroidx/appcompat/widget/SwitchCompat;->l:Z

    if-nez v2, :cond_6

    iget-boolean v2, v6, Landroidx/appcompat/widget/SwitchCompat;->m:Z
    ...
    iput-object v2, v6, Landroidx/appcompat/widget/SwitchCompat;->o:Landroid/content/res/ColorStateList;

    iput-boolean v13, v6, Landroidx/appcompat/widget/SwitchCompat;->q:Z
    ...
    invoke-static {v4, v10}, Ll/h0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v4

    iget-object v5, v6, Landroidx/appcompat/widget/SwitchCompat;->p:Landroid/graphics/PorterDuff$Mode;

    if-eq v5, v4, :cond_9

    iput-object v4, v6, Landroidx/appcompat/widget/SwitchCompat;->p:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v13, v6, Landroidx/appcompat/widget/SwitchCompat;->r:Z

    :cond_9
    iget-boolean v4, v6, Landroidx/appcompat/widget/SwitchCompat;->q:Z

    if-nez v4, :cond_a

    iget-boolean v4, v6, Landroidx/appcompat/widget/SwitchCompat;->r:Z
    ...
    sget-object v15, Lc/a;->z:[I

    invoke-virtual {v7, v4, v15}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v4, v1, v11}, Landroid/content/res/TypedArray;->getResourceId(II)I
    ...
    invoke-static {v9, v15, v10}, LA/m;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    iput-object v9, v6, Landroidx/appcompat/widget/SwitchCompat;->P:Landroid/content/res/ColorStateList;
    ...
    :goto_3
    invoke-virtual {v4, v11, v11}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I
    ...
    :goto_5
    invoke-virtual {v6, v1}, Landroidx/appcompat/widget/SwitchCompat;->setSwitchTypeface(Landroid/graphics/Typeface;)V
    ...
    :goto_8
    invoke-virtual {v12, v0}, Landroid/graphics/Paint;->setTextSkewX(F)V
    ...
    iput-object v1, v0, Lh/a;->a:Ljava/util/Locale;

    iput-object v0, v6, Landroidx/appcompat/widget/SwitchCompat;->S:Lh/a;
    ...
    :goto_a
    iget-object v0, v6, Landroidx/appcompat/widget/SwitchCompat;->w:Ljava/lang/CharSequence;

    invoke-direct {v6, v0}, Landroidx/appcompat/widget/SwitchCompat;->setTextOnInternal(Ljava/lang/CharSequence;)V

    iget-object v0, v6, Landroidx/appcompat/widget/SwitchCompat;->y:Ljava/lang/CharSequence;

    invoke-direct {v6, v0}, Landroidx/appcompat/widget/SwitchCompat;->setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v0, v6}, Ll/T;-><init>(Landroid/widget/TextView;)V

    const v1, 0x7f030270

    invoke-virtual {v0, v8, v1}, Ll/T;->g(Landroid/util/AttributeSet;I)V
    ...
    iput v2, v6, Landroidx/appcompat/widget/SwitchCompat;->C:I

    invoke-virtual {v0}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    invoke-direct/range {p0 .. p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Ll/y;

    move-result-object v0

    invoke-virtual {v0, v8, v1}, Ll/y;->b(Landroid/util/AttributeSet;I)V
    ...
    iput v0, v6, Landroidx/appcompat/widget/SwitchCompat;->H:I
    ...
    iput-object v0, v6, Landroidx/appcompat/widget/SwitchCompat;->c0:Ljava/lang/String;
    ...
    iput-object v0, v6, Landroidx/appcompat/widget/SwitchCompat;->d0:Ljava/lang/String;
    ...
    iput-object v0, v6, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroid/view/animation/PathInterpolator;
...
.method private getEmojiTextViewHelper()Ll/y;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->U:Ll/y;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->U:Ll/y;
...
.method private getThumbScrollRange()I
    ...
    :cond_0
    sget-object v0, Ll/h0;->c:Landroid/graphics/Rect;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Ll/y;

    move-result-object v0

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->S:Lh/a;

    iget-object v0, v0, Ll/y;->b:Ly1/c;

    iget-object v0, v0, Ly1/c;->j:Ljava/lang/Object;

    check-cast v0, LM0/g;

    invoke-virtual {v0, v1}, LM0/g;->K(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final c(Z)Z
    ...
    invoke-static {p0}, La1/b;->C(Landroid/view/View;)Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Ll/h0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Ll/h0;->c:Landroid/graphics/Rect;

    :goto_0
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
...
.method public final e()V
    ...
    invoke-direct/range {v1 .. v6}, LI/B;-><init>(ILjava/lang/Class;III)V

    invoke-virtual {v7, p0, v0}, LI/D;->d(Landroid/view/View;Ljava/lang/Object;)V
...
.method public final g()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->V:LP/h;
    ...
    invoke-direct {v1, p0}, LP/h;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->V:LP/h;

    invoke-virtual {v0, v1}, Landroidx/emoji2/text/h;->f(Landroidx/emoji2/text/f;)V
...
.method public final jumpDrawablesToCurrentState()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->T:Ll/d1;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->T:Ll/d1;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v6, p0, Landroidx/appcompat/widget/SwitchCompat;->v:Z

    if-eqz v6, :cond_1

    if-eqz v4, :cond_1

    invoke-static {v4}, Ll/h0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget v6, p0, Landroidx/appcompat/widget/SwitchCompat;->G:F
    ...
    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Landroid/content/res/ColorStateList;

    iget-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->O:Landroid/text/TextPaint;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->n:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1}, Ll/h0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final onMeasure(II)V
    ...
    iget-object v10, p0, Landroidx/appcompat/widget/SwitchCompat;->O:Landroid/text/TextPaint;

    if-nez v0, :cond_1

    iget-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->x:Ljava/lang/CharSequence;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->z:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->Q:Landroid/text/StaticLayout;

    invoke-virtual {v4}, Landroid/text/Layout;->getWidth()I

    move-result v4

    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->R:Landroid/text/StaticLayout;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->W:Landroid/graphics/Rect;
...
.method public setChecked(Z)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->T:Ll/d1;
    ...
    :cond_3
    invoke-direct {v0, p0, v1, v2}, Ll/d1;-><init>(Landroidx/appcompat/widget/SwitchCompat;FF)V
    ...
    invoke-direct {v1, p0, p1}, Ll/c1;-><init>(Landroidx/appcompat/widget/SwitchCompat;Z)V

    invoke-virtual {v0, v1}, Landroid/view/animation/Animation;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V

    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->T:Ll/d1;
