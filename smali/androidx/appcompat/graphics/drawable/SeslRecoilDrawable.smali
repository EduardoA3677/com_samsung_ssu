...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->s:Landroid/view/animation/LinearInterpolator;
    ...
    sput-object v0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->t:Landroid/view/animation/PathInterpolator;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->i:Z

    iput-boolean v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->j:Z
    ...
    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->k:Landroid/animation/ValueAnimator;

    const/4 v0, 0x0

    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->r:Ly1/c;
...
.method public constructor <init>(I[Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    iput p1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->n:I
...
.method public constructor <init>([Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->i:Z

    iput-boolean p1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->j:Z
    ...
    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->k:Landroid/animation/ValueAnimator;

    const/4 p1, 0x0

    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->r:Ly1/c;
...
.method public final a()I
    ...
    iget v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->n:I
    ...
    iget-object v1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->k:Landroid/animation/ValueAnimator;
...
.method public final b()V
    ...
    iput-wide v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->l:J

    const-wide/16 v0, 0x15e

    iput-wide v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->m:J
...
.method public final c(F)V
    ...
    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->k:Landroid/animation/ValueAnimator;
    ...
    iget-wide v1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->l:J
...
.method public final d(Landroid/content/res/TypedArray;)V
    ...
    iput v1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->n:I
    ...
    iput v1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->o:I
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->p:F

    iget v2, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->q:F
    ...
    iget v4, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->o:I
...
.method public final inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {}, LH0/a;->b()Landroid/graphics/BlendMode;

    move-result-object p2

    invoke-static {p1, p2}, LH0/a;->l(Landroid/graphics/drawable/Drawable;Landroid/graphics/BlendMode;)V
...
.method public final onStateChange([I)Z
    ...
    invoke-virtual {p0, v3}, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->c(F)V
    ...
    :cond_8
    iget-boolean v4, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->i:Z

    if-eqz v4, :cond_c

    if-nez v1, :cond_c

    iget-object v4, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->k:Landroid/animation/ValueAnimator;
    ...
    :cond_9
    iget-boolean v5, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->j:Z
    ...
    sget-object v0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->t:Landroid/view/animation/PathInterpolator;

    invoke-virtual {v4, v0}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-wide v2, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->m:J

    invoke-virtual {v4, v2, v3}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    invoke-virtual {v4}, Landroid/animation/ValueAnimator;->start()V

    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->r:Ly1/c;
    ...
    iget-object v2, v0, Ly1/c;->j:Ljava/lang/Object;

    check-cast v2, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;

    iget-object v3, v2, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->r:Ly1/c;
    ...
    :cond_b
    iput-object v4, v0, Ly1/c;->j:Ljava/lang/Object;

    :cond_c
    :goto_4
    iput-boolean v1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->i:Z

    iput-boolean v6, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->j:Z
...
.method public final setHotspot(FF)V
    ...
    iput p1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->p:F

    iput p2, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->q:F
