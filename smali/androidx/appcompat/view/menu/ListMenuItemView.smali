...
.field public C:Landroidx/appcompat/widget/SeslDropDownItemTextView;
...
.field public final z:Ljava/text/NumberFormat;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v2, Lc/a;->r:[I

    const v3, 0x7f030183

    invoke-static {v1, p2, v2, v3}, LA0/p;->m(Landroid/content/Context;Landroid/util/AttributeSet;[II)LA0/p;

    move-result-object p2

    const/4 v1, 0x5

    invoke-virtual {p2, v1}, LA0/p;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    iput v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->s:I
    ...
    iput-object v1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->v:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->z:Ljava/text/NumberFormat;
...
.method private setBadgeText(Ljava/lang/String;)V
    ...
    const-string p1, "SUB_MENU_ITEM_LAYOUT case, mBadgeView is null"
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->D:Landroid/widget/LinearLayout;

    if-nez v0, :cond_2

    const-string p1, "mTitleParent is null"
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->A:Landroid/widget/TextView;
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->z:Ljava/text/NumberFormat;
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->A:Landroid/widget/TextView;
    ...
    :cond_4
    iget-object v5, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->A:Landroid/widget/TextView;
...
.method public final b(Lk/k;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->i:Lk/k;

    invoke-virtual {p1}, Lk/k;->isVisible()Z
    ...
    iget-object v0, p1, Lk/k;->e:Ljava/lang/CharSequence;

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Lk/k;->isCheckable()Z

    move-result v0

    invoke-virtual {p0, v0}, Landroidx/appcompat/view/menu/ListMenuItemView;->setCheckable(Z)V

    iget-object v0, p1, Lk/k;->n:Lk/i;
    ...
    iget-char v0, p1, Lk/k;->j:C

    goto :goto_1

    :cond_1
    iget-char v0, p1, Lk/k;->h:C
    ...
    :goto_2
    iget-object v4, p1, Lk/k;->n:Lk/i;

    invoke-virtual {v4}, Lk/i;->n()Z

    iget-boolean v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->B:Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->i:Lk/k;

    iget-object v4, v0, Lk/k;->n:Lk/i;

    invoke-virtual {v4}, Lk/i;->o()Z
    ...
    iget-char v0, v0, Lk/k;->j:C

    goto :goto_3

    :cond_4
    iget-char v0, v0, Lk/k;->h:C
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->i:Lk/k;

    iget-object v5, v4, Lk/k;->n:Lk/i;

    invoke-virtual {v5}, Lk/i;->n()Z

    move-result v5

    if-eqz v5, :cond_7

    iget-char v5, v4, Lk/k;->j:C

    goto :goto_6

    :cond_7
    iget-char v5, v4, Lk/k;->h:C
    ...
    :cond_8
    iget-object v6, v4, Lk/k;->n:Lk/i;

    iget-object v7, v6, Lk/i;->a:Landroid/content/Context;
    ...
    iget-object v9, v6, Lk/i;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v9, v6, v8}, Lk/k;->d(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v3, v6, v8}, Lk/k;->d(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v6, v3, v8}, Lk/k;->d(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-static {v4, v1, v3, v8}, Lk/k;->d(IILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    :cond_f
    :goto_a
    invoke-virtual {p1}, Lk/k;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lk/k;->q:Ljava/lang/CharSequence;
...
.method public getItemData()Lk/k;
    .locals 1
...
.method public final onFinishInflate()V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->C:Landroidx/appcompat/widget/SeslDropDownItemTextView;
    ...
    iget v3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->s:I
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object v0, v0, Lk/k;->e:Ljava/lang/CharSequence;
...
.method public setCheckable(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->C:Landroidx/appcompat/widget/SeslDropDownItemTextView;

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->i:Lk/k;

    invoke-virtual {v0}, Lk/k;->isChecked()Z
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->i:Lk/k;

    invoke-virtual {p1}, Lk/k;->isChecked()Z
...
.method public setChecked(Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->C:Landroidx/appcompat/widget/SeslDropDownItemTextView;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v1}, Ll/P0;->setVisibility(I)V
    ...
    invoke-virtual {p1, v2}, Ll/P0;->setVisibility(I)V
