...
.method public constructor <init>(Landroidx/emoji2/text/p;)V
    ...
    iput-object p1, p0, Landroidx/emoji2/text/h;->i:Landroidx/emoji2/text/c;
    ...
    iput-object p1, p0, Landroidx/emoji2/text/h;->b:Lo/g;

    new-instance p1, Lo1/d;

    const/16 v4, 0xc

    invoke-direct {p1, v4}, Lo1/d;-><init>(I)V

    iput-object p1, p0, Landroidx/emoji2/text/h;->g:Lo1/d;

    new-instance p1, Landroidx/emoji2/text/e;

    invoke-direct {p1, p0}, Landroidx/emoji2/text/e;-><init>(Landroidx/emoji2/text/h;)V

    iput-object p1, p0, Landroidx/emoji2/text/h;->e:Landroidx/emoji2/text/e;
    ...
    invoke-interface {v1, v0}, Landroidx/emoji2/text/g;->a(La1/b;)V
    :try_end_1
...
.method public final c()V
    ...
    iget-object v0, p0, Landroidx/emoji2/text/h;->e:Landroidx/emoji2/text/e;

    iget-object v1, v0, Landroidx/emoji2/text/e;->a:Landroidx/emoji2/text/h;
    ...
    iget-object v0, v1, Landroidx/emoji2/text/h;->f:Landroidx/emoji2/text/g;

    invoke-interface {v0, v2}, Landroidx/emoji2/text/g;->a(La1/b;)V
    :try_end_2
    ...
    invoke-virtual {v1, v0}, Landroidx/emoji2/text/h;->d(Ljava/lang/Throwable;)V
...
.method public final d(Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Landroidx/emoji2/text/h;->b:Lo/g;
    ...
    iget v3, p0, Landroidx/emoji2/text/h;->c:I

    invoke-direct {v2, v0, v3, p1}, LD0/j;-><init>(Ljava/util/List;ILjava/lang/Throwable;)V
...
.method public final e(Ljava/lang/CharSequence;II)Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v2, p0, Landroidx/emoji2/text/h;->e:Landroidx/emoji2/text/e;

    iget-object v3, v2, Landroidx/emoji2/text/e;->b:LA0/p;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v2, p1, Landroidx/emoji2/text/s;
    ...
    invoke-virtual {v4}, Landroidx/emoji2/text/s;->a()V

    :cond_6
    const-class v4, Landroidx/emoji2/text/u;
    ...
    iput-boolean v1, v0, Landroidx/emoji2/text/v;->i:Z

    new-instance v5, Landroid/text/SpannableString;

    invoke-direct {v5, p1}, Landroid/text/SpannableString;-><init>(Ljava/lang/CharSequence;)V

    iput-object v5, v0, Landroidx/emoji2/text/v;->j:Landroid/text/Spannable;
    ...
    invoke-direct {v0, v5}, Landroidx/emoji2/text/v;-><init>(Landroid/text/Spannable;)V

    :cond_9
    :goto_5
    if-eqz v0, :cond_b

    iget-object v5, v0, Landroidx/emoji2/text/v;->j:Landroid/text/Spannable;
    ...
    iget-object v7, v0, Landroidx/emoji2/text/v;->j:Landroid/text/Spannable;

    invoke-interface {v7, v6}, Landroid/text/Spanned;->getSpanStart(Ljava/lang/Object;)I

    move-result v7

    iget-object v8, v0, Landroidx/emoji2/text/v;->j:Landroid/text/Spannable;
    ...
    invoke-virtual {v0, v6}, Landroidx/emoji2/text/v;->removeSpan(Ljava/lang/Object;)V
    ...
    iget-object p2, v3, LA0/p;->j:Ljava/lang/Object;

    check-cast p2, Lo1/d;

    const/16 p3, 0x17

    invoke-direct {v9, v0, p3, p2}, Lcom/google/android/gms/internal/measurement/g1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-virtual/range {v3 .. v9}, LA0/p;->o(Ljava/lang/CharSequence;IIIZLandroidx/emoji2/text/l;)Ljava/lang/Object;
    ...
    iget-object p2, p2, Landroidx/emoji2/text/v;->j:Landroid/text/Spannable;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p2}, Landroidx/emoji2/text/s;->b()V
...
.method public final f(Landroidx/emoji2/text/f;)V
    .locals 4
    ...
    :cond_0
    iget-object v0, p0, Landroidx/emoji2/text/h;->b:Lo/g;
    ...
    filled-new-array {p1}, [Landroidx/emoji2/text/f;
    ...
    invoke-direct {v1, p1, v2, v3}, LD0/j;-><init>(Ljava/util/List;ILjava/lang/Throwable;)V
    ...
    :goto_1
    iget-object p1, p0, Landroidx/emoji2/text/h;->a:Ljava/util/concurrent/locks/ReentrantReadWriteLock;
